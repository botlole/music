...
OWNER_ID = int(getenv("OWNER_ID", 7278006130))
...
CHANNEL_NAME = getenv("CHANNEL_NAME", "تحديثات لولي")
CHANNEL_LINK = getenv("CHANNEL_LINK", "https://t.me/WOGRED")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/WOGRED")
