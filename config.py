...
CHANNEL_NAME = getenv("CHANNEL_NAME", "تحديثات Kem")
CHANNEL_LINK = getenv("CHANNEL_LINK", "https://t.me/t_x_zz")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/t_x_zz")
