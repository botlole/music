...
OWNER_ID = int(getenv("OWNER_ID", 5123927563))
...
CHANNEL_NAME = getenv("CHANNEL_NAME", "تحديثات كريس")
CHANNEL_LINK = getenv("CHANNEL_LINK", "https://t.me/rcStore0")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/rcStore0")
